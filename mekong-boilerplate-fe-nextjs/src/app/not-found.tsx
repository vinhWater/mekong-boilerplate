...
export const metadata: Metadata = {
  title: "Page Not Found | TikTok Shop Automation Platform",
  description: "The page you're looking for doesn't exist. Return to TikTok Shop Automation Platform.",
};
              ...
              <div className="w-full px-4">
                <div className="mx-auto max-w-[530px] text-center">
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    ...
                    deleted or does not exist. Let's get you back to managing your TikTok Shop.
                  </p>
                  <Link
                    href="/login"
